      ...
      <div class="portfolio-section grid md:grid-cols-3 gap-5 mx-5 mt-10 -z-10">
        <div v-for="(item, index) in portfolio" :key="index"
          ...
          ease-in-out px-6 py-4">
            ...
            <div class="flex">
              <p class="text-white font-display font-bold text-2xl hover:opacity-100">
                {{ item.service }}
              </p>
              <div>
          ...
          <div class="">
            ...
            <div class="text-xs font-dispaly uppercase font-bold tracking-wider md:hidden text-[#df9f1f] mt-5">
              Project
            </div>
            <div class="md:hidden">
              {{ item.service }}
