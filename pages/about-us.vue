    ...
    <div class="min-h-screen">
      <div class="bg-slate-100">
        <div class="max-w-[1200px]  mx-auto py-16">
          ...
          <div class=" w-full h-auto md:mx-auto py-10 px-8 md:py-10 md:px-52 leading-loose space-y-2 md:space-y-6">
      ...
      <div class="max-w-6xl mx-auto py-10">
        <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div class="flex justify-center text-lg mt-5 leading-relaxed text-gray-700 ">
              <ol class="">
      ...
      <div class="bg-slate-100 py-16 mt-16">
        <div class="max-w-[1200px] mx-auto md:px-48 space-y-8">
            ...
            <div class="flex mx-auto items-center">
              <ul class="">
                <div v-for="(approach, index) in approaches" :key="index" class="flex items-baseline gap-4 space-y-10">
                  <div class="text-gray-200 font-bold text-5xl font-display">
                    0{{ index + 1 }}.
                  </div>
                  <li>{{ approach }}</li>
                </div>
