  ...
  <div class="">
    <div
      ...
      <div class="absolute inset-0 bg-[#0C3C60] bg-opacity-90 z-0">
        <div class="h-auto mx-auto pl-7 pr-16 md:pl-7 md:pr-16 lg:px-0 max-w-6xl mt-[150px] z-50 mb-10">
          <!--  -->
          ...
          <div class="mt-5 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
            ...
            <!-- gs_reveal -->
            <div class="gs_reveal space-y-3 text-white pb-3 border-b">
              <h3 class="uppercase font-bold font-display text-gray-200">Follow Us</h3>
              <div class="flex mt-4 space-x-6 sm:mt-0">
                <a href="https://www.youtube.com/@aegirconsult" target="_blank" rel="noopener noreferrer">
                  <svg style="" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    class="text-white hover:text-[#df9f1f] bi bi-youtube" viewBox="0 0 16 16">
                    <path
                ...
                <a href="https://twitter.com/AegirConsult" target="_blank" class="text-white hover:text-[#df9f1f]">
