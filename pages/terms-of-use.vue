...
<template>
  <div class="w-full bg-blue-200 h-auto py-20">
    <div class="mx-8 md:mx-14 lg:mx-20 my-5 md:my-10">
      ...
      <div class="md-8 md:mx-20 lg:mx-40 text-sm space-y-1-2 md:space-y-5 leading-loose justify-start">
        <h4 class="text-base font-semibold tracking-wide uppercase text-center mb-1">
          Introduction
        </h4>
        <p>
          Welcome to Aegir Consult (“Company”, “we”, “our”, “us”), these Terms
          of Service (“Terms”, “Terms of Service”) govern your use of our
          website located at aegirconsult.biz (together or individually
          “Service”) operated by Aegir Consult. Our Privacy Policy also governs
        ...
        <p>
          ...
          but please let us know by emailing at info@aegirconsult.biz so we can
        ...
        <p>
          ...
          Terms. Aegir Consult has the right but not the obligation to monitor
          and edit all Content provided by users. In addition, Content found on
          or through this Service are the property of Aegir Consult or used with
        ...
        <p>
          ...
          Terms. You agree not to use Service: 1. In any way that violates any
          applicable national or international law or regulation. 2. For the
          ...
          otherwise. 3. To transmit, or procure the sending of, any advertising
          or promotional material, including any “junk mail”, “chain letter,”
          “spam,” or any other similar solicitation. 4. To impersonate or
          attempt to impersonate Company, a Company employee, another user, or
          any other person or entity. 5. In any way that infringes upon the
          ...
          or harmful purpose or activity. 6. To engage in any other conduct that
          restricts or inhibits anyone’s use or enjoyment of Service, or which,
          as determined by us, may harm or offend Company or users of Service or
          expose them to liability. Additionally, you agree not to: 7. Use
          ...
          Service. 8. Use any robot, spider, or other automatic device, process,
          or means to access Service for any purpose, including monitoring or
          copying any of the material on Service. 9. Use any manual process to
          monitor or copy any of the material on Service or for any other
          unauthorized purpose without our prior written consent. 10. Use any
          device, software, or routine that interferes with the proper working
          of Service. 11. Introduce any viruses, trojan horses, worms, logic
          bombs, or other material which is malicious or technologically
          harmful. 12. Attempt to gain unauthorized access to, interfere with,
          ...
          13. Attack Service via a denial-of-service attack or a distributed
          denial-of-service attack. 14. Take any action that may damage or
          falsify Company rating. 15. Otherwise attempt to interfere with the
          proper working of Service. Analytics
        </p>
        <p>
        ...
        <p>
          ...
          property of Aegir Consult and its licensors. Service is protected by
          ...
          without the prior written consent of Aegir Consult.
        </p>
        <h4 class="text-base font-semibold tracking-wide uppercase text-center mb-1">
          Copyright Policy
        </h4>
        <p>
          ...
          info@aegirconsult.biz, with the subject line: “Copyright Infringement”
        ...
        <p>
          ...
          contact our Copyright Agent via email at info@aegirconsult.biz.
        </p>
        <h4 class="text-base font-semibold tracking-wide uppercase text-center mb-1">
          Error Reporting and Feedback
        </h4>
        <p>
          You may provide us either directly at info@aegirconsult.biz or via
        ...
        <p>
          ...
          that are not owned or controlled by Aegir Consult.
        </p>
        <p>
          Aegir Consult has no control over, and assumes no responsibility for
        ...
        <p>
          ...
          legal documents. PolicyMaker’s free Terms and Conditions generator is
        ...
        <p>
          ...
          laws of Kenya, which governing law applies to agreement without regard
        ...
        <p>
          These Terms of Service were created for aegirconsult.systems on
          2020-08-03.
        </p>
      </div>
    </div>
