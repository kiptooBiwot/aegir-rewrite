  ...
  <div class="bg-slate-100">
    ...
    <div class="max-w-6xl py-10 mx-auto pl-7 pr-16 xl:px-0 main-content">
      <div class="mb-10 md:mb-0">
        ...
        <p class="gs_reveal">
          Here are a part of our achievements, awards, and major projects that
          we've had the pleasure of being a part of.
        </p>
      </div>
      <div
        class="flex items-center justify-center py-4 md:py-8 flex-wrap gap-2"
      >
        <template v-for="(button, index) in yearButtons" :key="index">
          <div
            ...
            :class="[
              newsStore.selectedYearIndex === index
                ? 'bg-[#2698f0] text-gray-100 shadow-lg'
                : '',
            ]"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div
          v-for="(activity, i) in newsStore.selectedActivities"
          :key="i"
          class=""
        >
          <div class="relative h-64 cursor-pointer">
            <img
              class="h-full absolute inset-0 w-full rounded-lg object-fill"
              :src="activity.image"
              alt=""
            />
            ...
            >
              ...
              <div class="flex">
                <p
                  class="text-white font-display font-bold text-xl hover:opacity-100"
                >
                  {{ activity.title }}
                </p>
                <div>
              ...
              <div>
                <p
                  class="text-[#df9f1f] font-display font-bold text-lg hover:opacity-100"
                >
                  {{ activity.date }}
                </p>
              </div>
