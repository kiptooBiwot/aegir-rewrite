...
const menuItems = reactive([
  ...
  { title: 'Services', link: '/our-offerings/services' },
    ...
    <div class="mx-auto w-full max-w-screen-xl px-7 md:px-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{ new Date().getFullYear() }} <a
            href="https://aegirconsult.systems" class="hover:underline">Aegir Consult Limited</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a href="https://www.youtube.com/@aegirconsult" target="_blank" rel="noopener noreferrer">
            <svg style="" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
              class="text-gray-500 hover:text-white bi bi-youtube" viewBox="0 0 16 16">
              <path
          ...
          <a href="https://twitter.com/AegirConsult" target="_blank" class="text-gray-500 hover:text-white">
          ...
          <a href="tel:+254725587783" target="_blank" class="text-gray-500 hover:text-white">
          ...
          <a href="https://www.linkedin.com/company/aegir-consult-limited/about/" target="_blank"
